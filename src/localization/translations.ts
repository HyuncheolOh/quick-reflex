...
export const ko = {
  ...
  statistics: {
    ...
    insights: {
      ...
      improved: (percentage: number) =>
        `최근 ${percentage}% 향상되었습니다! 🎉`,
      declined: (percentage: number) =>
        `최근 성과가 ${percentage}% 하락했습니다. 더 집중해보세요! 💪`,
  ...
  leaderboard: {
    ...
    consent: {
      ...
      description:
        "게임 결과를 리더보드에 공유하여 다른 플레이어들과 순위를 비교할 수 있습니다.",
    },
    dataRetention: {
      title: "데이터 보존 안내",
      message:
        "앱을 삭제하면 모든 데이터(닉네임, 기록 등)가 함께 삭제됩니다. 이를 이해하셨나요?",
      acknowledge: "이해했습니다",
    },
    filters: {
      title: "정렬",
...
export const en = {
  ...
  results: {
    ...
    averageImprovement: (time: string) =>
      `Average reaction time improved by ${time}!`,
    averageDecline: (time: string) =>
      `Average reaction time slowed by ${time}.`,
  ...
  statistics: {
    ...
    insights: {
      ...
      improved: (percentage: number) =>
        `Improved by ${percentage}% recently! 🎉`,
      declined: (percentage: number) =>
        `Performance declined by ${percentage}% recently. Stay focused! 💪`,
  ...
  modals: {
    ...
    resetData: {
      title: "Reset Data",
      message:
        "All game records and settings will be deleted.\nAre you sure you want to reset?",
      confirm: "Reset",
      cancel: "Cancel",
    },
    confirmModal: {
  ...
  leaderboard: {
    ...
    consent: {
      ...
      description:
        "Share your game results on the leaderboard to compare rankings with other players.",
    },
    dataRetention: {
      title: "Data Retention Notice",
      message:
        "If you delete the app, all data (nickname, records, etc.) will be deleted together. Do you understand this?",
  ...
  validation: {
    ...
    nicknameRules:
      "Nickname must be 2-20 characters using only Korean, English, or numbers.",
